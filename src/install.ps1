<#
	.SYNOPSIS
		Installs the PSCloudCommunicationReport Module from github
		
	.DESCRIPTION
		This script installs the PSCloudCommunicationReport Module from github.
...
$ModuleName = "PSCloudCommunicationReport"

# Base path to the github repository
$BaseUrl = "https://github.com/<InsertUsernameHere>/PSCloudCommunicationReport"

# If the module is in a subfolder of the cloned repository, specify relative path here. Empty string to skip.
$SubFolder = "PSCloudCommunicationReport"
