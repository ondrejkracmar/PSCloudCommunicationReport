...
Remove-Module PSCloudCommunicationReport -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\PSCloudCommunicationReport.psd1"
Import-Module "$PSScriptRoot\..\PSCloudCommunicationReport.psm1" -Force
